...
class CustomArticleSearchListView extends StatelessWidget {
  const CustomArticleSearchListView({super.key, required this.articles});
      ...
      itemBuilder: (context, index) {
        return InkWell(
          onTap: () {
            GoRouter.of(
              context,
            ).pushNamed(AppRoutes.articleDetailsView, extra: articles[index]);
          },
          child: ListTile(
